...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { area_code: @area.area_code, area_name: @area.area_name } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { area_code: @area.area_code, area_name: @area.area_name } }
