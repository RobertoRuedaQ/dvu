...
class CampusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campu" do
    assert_difference('Campu.count') do
      post campus_url, params: { campu: { campus_code: @campu.campus_code, campus_name: @campu.campus_name } }
    end
  ...
  test "should update campu" do
    patch campu_url(@campu), params: { campu: { campus_code: @campu.campus_code, campus_name: @campu.campus_name } }
