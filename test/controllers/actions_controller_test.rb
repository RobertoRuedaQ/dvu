...
class ActionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action" do
    assert_difference('Action.count') do
      post actions_url, params: { action: { action_code: @action.action_code, action_name: @action.action_name } }
    end
  ...
  test "should update action" do
    patch action_url(@action), params: { action: { action_code: @action.action_code, action_name: @action.action_name } }
