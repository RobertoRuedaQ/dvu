...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { type_code: @type.type_code, type_name: @type.type_name } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { type_code: @type.type_code, type_name: @type.type_name } }
